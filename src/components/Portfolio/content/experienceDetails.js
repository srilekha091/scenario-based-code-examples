const experienceDetails = [
	{
		...
		jobResponsibilities: [
			`Building features using React components, lifecycle methods, forms, events, states, props, keys and routing to build and extend the capabilities of the company’s internal portal.`,
